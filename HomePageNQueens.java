...
public class HomePageNQueens extends JFrame implements ActionListener,MouseListener{
    ...
    public static void main(String[] args) {
        HomePageNQueens n=new HomePageNQueens();
    }
